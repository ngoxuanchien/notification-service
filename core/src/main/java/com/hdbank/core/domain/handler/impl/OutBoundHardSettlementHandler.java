...
import com.hdbank.core.domain.service.NotificationErrorService;
...
public class OutBoundHardSettlementHandler implements NotificationTypeHandler {
    ...
    public String getNotificationType() {
        return NotificationTypeConstant.OUTBOUND_HARD_SETTLEMENT;
    }
}
